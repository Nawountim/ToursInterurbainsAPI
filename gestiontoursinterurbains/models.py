...
class Momo_transaction(models.Model):
    ...
    statuscode = models.CharField(max_length = 25, null= True)
    message =  models.CharField(max_length = 30, null=True)
    numero_transaction = models.BigIntegerField()
    montant = models.FloatField()
    reference_operateur_id = models.BigIntegerField(null=True)
    operateur = models.CharField(max_length = 30, null=True)
